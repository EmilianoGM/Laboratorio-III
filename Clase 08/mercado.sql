...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-10-2019 a las 17:00:13
...
CREATE TABLE `usuarios` (
  ...
  `pathFoto` varchar(80) COLLATE latin1_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
...
INSERT INTO `usuarios` (`id`, `nombre`, `apellido`, `clave`, `perfil`, `estado`, `correo`, `pathFoto`) VALUES
(2, 'juan', 'perez', '1234', 1, 1, 'a123@mail.com', ''),
(3, 'Pedro', 'Gonzalez', '65473', 2, 7, '', ''),
